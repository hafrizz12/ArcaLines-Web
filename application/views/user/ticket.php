...
<head>
    ...
    <title>Arcalines | My Ticket</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light mobile" style="padding: 1rem;">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('user/ticket') ?>"><b>My Tickets</b></a>
            </li>
            <li class="nav-item">
                ...
                <div class="row" style="padding: 1rem;">
                    ...
                    <div style="margin-top: 1rem;" class="col-12">
                        <div class="row">
                            ...
                            <div class="col-10">
                                <a class="heading-sidebar-active" href="<?php echo base_url('user/ticket'); ?>">My Tickets</a>
                            </div>
                        </div>
                    </div>
                    <div style="margin-top: 1rem;" class="col-12">
            ...
            <div class="col" style="padding: 0;">
                        ...
                        <div class="container-fluid padding-pc">
                            <div class="row">
                                <div class="col-md-6 d-flex justify-content-start align-items-center">
                                    <a class="heading-dashboard text-center fs-2">Tickets</a>
                                </div>
                ...
                <div class="container-fluid padding-pc">
                    ...
                    <div class="col-12 col-md-9" style="margin-top: 1rem;">
                        <h3 class="heading-dashboard">My Tickets</h3>
                        <div class="recent-files" style="overflow-y: auto; height: 50vh;">
                                    <?php
                                    if (!$bookings) {
                                        echo '<h5 class="heading-overview-data-admin">There are no ticket history!</h5>';
                                    }
                                    ...
                                    <div class="col-md-12 col-12" style="margin-top: 1rem;">
                                        <div class="card">
                                            <div class="card-body">
                                              ...
                                              <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo $pass->BookingID; ?>">
