    ...
    function deleteConfirm(x) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php echo base_url('routes/delete?id=');?>" + x;
            }
            });
    }
            ...
            <div class="col" style="padding: 0;">
                        ...
                        <div class="container-fluid padding-pc">
                            <div class="row">
                                <div class="col-md-6 d-flex justify-content-start align-items-center">
                                    <a class="heading-dashboard text-center fs-2">Routes</a>
                                </div>
                ...
                <div class="container-fluid padding-pc">
                    ...
                    <div class="col-12 col-md-9" style="margin-top: 1rem;">
                        <h2 class="heading-dashboard">Active Routes</h2>
                            ...
                            <div class="col-md-3 col-6" style="margin-right: 1rem;">
                                        <div class="card">
                                            <div class="card-body">
                                              ...
                                              <a>Distance <?php echo $route->Distance; ?>mi</a><br style="margin-bottom: 1rem;">
                                                <a href="<?php echo base_url('routes/edit/' . $route->RoutesID); ?>" class="btn btn-primary">Edit</a>
                                              <button class="btn btn-danger" onclick="deleteConfirm('<?php echo $route->RoutesID; ?>')" value="<?php echo $route->RoutesID; ?>">Delete</button>
                                            </div>
                                          </div>
                                    </div>
                            <?php
                    ...
                    <div class="col-12 col-md-9" style="margin-top: 1rem;">
                        <h2 class="heading-dashboard">Create a new Route</h2>
                        <div class="recent-files d-flex flex-nowrap" style="overflow-x: auto;">
                            <form action="<?php echo base_url('routes/add'); ?>" method="post">
                                <label for="Planes to Assign">Planes to Assign</label>
                                <select class="form-control select2" style="width: 100%;" name="plane" id="plane">
                                    <?php
                                    foreach ($unusedPlanes as $plane) {
                                    ?>
                                    <option value="<?php echo $plane->AircraftID; ?>"><?php echo $plane->AircraftName; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
                                <input type="text" name="origin" id="origin" placeholder="Origin City" class="form-control" style="width: 100%; margin-top: 1rem;" >
                                <input type="text" name="destination" id="destination" placeholder="Destination City" class="form-control" style="width: 100%; margin-top: 1rem;">
                                <input type="number" name="distance" id="distance" placeholder="Distance" class="form-control" style="width: 100%; margin-top: 1rem;">
                                <input type="number" name="price" id="price" placeholder="Price" class="form-control" style="width: 100%; margin-top: 1rem;">
