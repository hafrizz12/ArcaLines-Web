...
<head>
    ...
    <title>Arcalines | Dashboard</title>
                        ...
                        <div class="container-fluid padding-pc">
                            <div class="row">
                                <div class="col-md-6 d-flex justify-content-start align-items-center">
                                    <a class="heading-dashboard text-center fs-2">Dashboard</a>
                                </div>
                        ...
                        <div class="col-md-9" style="padding: 0;">
                            <div class="container-fluid" style="padding: 0;">
                                <div class="row" style="margin: 0;">
                                    ...
                                    <div class="col-md-4 mobile-overiew">
                                        <div class="card" style="width: 90%;">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-2 d-flex justify-content-center align-items-center" >
                                                        <i style="border: 7px #3B6FBD solid; background-color: #3B6FBD; border-radius: 3rem; color: white;" class="fas fa-map"></i>
                                                    </div>
                                                    <div class="col-10">
                                                        <b class="heading-sidebar-active">Active Routes</b><br>
                                                        <h5 class="heading-overview-data-admin"><?php echo $totalRoutes; ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card" style="width: 90%;">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-10">
                                                        <b class="heading-sidebar-active">Passengers</b><br>
                                                        <h5 class="heading-overview-data-admin"><?php echo number_format($totalPassenger, 0, ',', '.'); ?> this month.</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
