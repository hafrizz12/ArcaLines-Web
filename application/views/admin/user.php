    ...
    function deleteConfirm(x) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php echo base_url('users/delete/') ?>" + x;
            }
            });
    }
        ...
        <div class="row">
            ...
            <div class="col" style="padding: 0;">
                ...
                <div class="container-fluid padding-pc">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-2 d-flex justify-content-center align-items-center" >
                                                        <i style="border: 7px #3F357D solid; background-color: #3F357D; border-radius: 3rem; color: white;" class="fas fa-user"></i>
                                                    </div>
                                                    <div class="col-10">
                                                        <b class="heading-sidebar-active">Active User</b><br>
                                                        <h5 class="heading-overview-data-admin"><?php echo number_format($userCount, 0, ',', '.'); ?></h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <h3 class="heading-dashboard">Users</h3>
                                ...
                                if (count($users) > 0) {
                                    ...
                                    foreach ($users as $users) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="'. base_url('users/edit/') . $users->UserID .'"><button class="btn btn-primary">Edit</button></a>
                                            <a><button class="btn btn-danger" onclick="deleteConfirm('. $users->UserID .' )">Delete</button></a>
                                            </td>
                                        </tr>
                                        ';
                                    }
